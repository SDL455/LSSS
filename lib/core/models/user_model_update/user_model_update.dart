...
//
//     final usermodelupdate = usermodelupdateFromJson(jsonString);

import 'dart:convert';

Usermodelupdate usermodelupdateFromJson(String str) =>
    Usermodelupdate.fromJson(json.decode(str));

String usermodelupdateToJson(Usermodelupdate data) =>
...
class Usermodelupdate {
  ...
  DateTime? passTrainingDate;
  dynamic joinkvDate;
  dynamic joinPoliceDate;
  dynamic joinBackupPartyDate;
  dynamic joinPartyDate;
  dynamic dateSetByGov;
  dynamic positionByGov;
  ...
  factory Usermodelupdate.fromJson(Map<String, dynamic> json) =>
      Usermodelupdate(
        ...
        passTrainingDate: json["passTrainingDate"] == null
            ? null
            : DateTime.parse(json["passTrainingDate"]),
        joinkvDate: json["joinkvDate"],
        joinPoliceDate: json["joinPoliceDate"],
        joinBackupPartyDate: json["joinBackupPartyDate"],
        joinPartyDate: json["joinPartyDate"],
        dateSetByGov: json["dateSetByGov"],
  ...
  Map<String, dynamic> toJson() => {
        ...
        "passTrainingDate": passTrainingDate?.toIso8601String(),
        "joinkvDate": joinkvDate,
        "joinPoliceDate": joinPoliceDate,
        "joinBackupPartyDate": joinBackupPartyDate,
        "joinPartyDate": joinPartyDate,
        "dateSetByGov": dateSetByGov,
